...
test("la propiedad de stacks queda aislada por servidor destino", () => {
	const uno = stackOwnershipRegistryPath(
		{ user: "root", host: "203.0.113.10" },
		BASE,
	);
	const otro = stackOwnershipRegistryPath(
		{ user: "root", host: "203.0.113.11" },
		BASE,
	);
...
test("usuario y puerto sí distinguen destinos SSH diferentes", () => {
	const root22 = stackOwnershipRegistryPath(
		{ user: "root", host: "host", port: 22 },
		BASE,
	);
	const ubuntu22 = stackOwnershipRegistryPath(
		{ user: "ubuntu", host: "host", port: 22 },
		BASE,
	);
	const root2222 = stackOwnershipRegistryPath(
		{ user: "root", host: "host", port: 2222 },
		BASE,
	);
